    ...
    return (
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold text-app-green mb-1">Results for "<span className="text-gradient">{query}</span>"</h1>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 animate-scale-in">
                        <div className="size-20 rounded-full bg-white flex-center shadow-soft mx-auto mb-4">
                            <Search className="size-9 text-app-border" />
                        </div>
                        <h2 className="text-xl font-bold text-app-green mb-2">No results found</h2>
